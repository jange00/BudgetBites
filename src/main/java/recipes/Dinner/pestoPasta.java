 ...
 * @author mohandhakal
 */
public class pestoPasta extends javax.swing.JFrame {

    /**
     * Creates new form pestoPasta
     */
    public pestoPasta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/pestopasta.png"))); // NOI18N
        jLabel1.setToolTipText("");

        jLabel5.setFont(new java.awt.Font("Avenir Next", 1, 25)); // NOI18N
        jLabel5.setText("One-Pot Pesto Pasta");
        ...
        jTextArea2.setText("This Creamy Pesto Chicken Pasta comes together in about 25 minutes, is super luscious and creamy, and uses just a few simple ingredients. ;)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pestoPasta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pestoPasta().setVisible(true);
            }
        });
    }
