 ...
 * @author mohandhakal
 */
public class eggs extends javax.swing.JFrame {

    /**
     * Creates new form eggs
     */
    public eggs() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/eggs.png"))); // NOI18N

        jLabel5.setFont(new java.awt.Font("Avenir Next", 1, 25)); // NOI18N
        jLabel5.setText("Scrambled Eggs");
        ...
        jTextArea2.setText("With our tips and straightforward recipe, you can    make soft, creamy, and delicious scrambled eggs.");
        ...
        jTextArea1.setText("Ingredients:\n1/2 tbsp. Butter\n4 Eggs\nsmall pinch of salt\n\nScrambled eggs should be soft, creamy and gently scrambled. A quality non-stick pan and silicone spatula are really useful. \nIt’s important that you use low heat and don’t forget about the chance of carryover cooking. Eggs are delicate and cook very quickly.\nGive the eggs a few seconds in the hot pan (off the heat) and you’ll find the eggs turn out to be perfectly cooked — not dry, and not too wet.\n\nMethod:\n\nMelt the butter in a medium non-stick pan over medium-low heat.\nCrack eggs into a bowl, add a pinch of salt and whisk until well blended.\nWhen the butter begins to bubble, pour in the eggs and immediately \nUse a silicone spatula to swirl in small circles around the pan, without stopping, until the eggs look slightly thickened and very small curds begin to form, about 30 seconds.\nChange from making circles to making long sweeps across the pan until you see larger, creamy curds; about 20 seconds.\nWhen the eggs are softly set and slightly runny in places, remove the pan from the heat and leave for a few seconds to finish cooking.\nGive a final stir and serve immediately. Serve with an extra sprinkle of salt, a grind of black pepper and a few fresh chopped herbs (if desired).\n");
